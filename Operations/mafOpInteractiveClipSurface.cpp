...
//----------------------------------------------------------------------------
{
	...
	transform_data_input->SetInputData((vtkPolyData *)((mafVME *)m_Input)->GetOutput()->GetVTKData());
  ...
  else
  {
      ...
      if (m_TestMode)
      {
		...
		else
		{
			...
			m_Clipper->SetInputData(vtkPolyData::SafeDownCast(((mafVME *)m_Input)->GetOutput()->GetVTKData()));
